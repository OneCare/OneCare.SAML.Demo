...
namespace OneCare.Portal.SP.Models
{
	public class UserModel : IPrincipal, IIdentity
	{
		...
		public ExternalAccountModel ExternalAccount { get; set; }
		...
		{
			return (role.ToLower() == "admin") ? this.IsAdmin() : false;
		}
	...
	public class UserDoc
	{
		...
		public string FirstName { get; set; }
		public string LastName { get; set; }
		public List<ExternalAccountDoc> ExternalAccounts { get; set; }
	}
