...
namespace OneCare.Portal.SP.Models
{
	public class Database
	{
		...
		public static T FindUnique<T>(Func<T, bool> filter)
		{
			return Read<T>(session =>
				session.Query<T>().SingleOrDefault(filter));
		}
	...
	{
		public const string PartnerApp = "PartnerApp";
		public const string PartnerUsername = "PartnerUsername";
		public const string PartnerSSOReceived = "PartnerSSOReceived";
	}
}